			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6 col-xs-6 text-center menu-1">
						<ul>
							<li class="has-dropdown active"><a href="product.html">Shop</a>
								<ul class="dropdown">
					...
					<div class="col-md-10 col-md-offset-1 animate-box">
						...
						<div class="row animate-box">
							<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
								...
								<p>
									<a href="#" class="btn btn-primary btn-outline btn-lg">Add
										to Cart</a> <a href="#" class="btn btn-primary btn-outline btn-lg">Compare</a>
								</p>
							</div>
						</div>
					</div>
					...
					<div class="col-md-10 col-md-offset-1">
						<div class="fh5co-tabs animate-box">
							...
							<div class="fh5co-tab-content-wrap">
								...
								<div class="fh5co-tab-content tab-content active"
									...
									<div class="col-md-10 col-md-offset-1">
										...
										<p>Paragraph placeat quis fugiat provident veritatis quia
											...
											eius nobis reprehenderit soluta eligendi quo reiciendis
											fugit? Veritatis tenetur odio delectus quibusdam officiis
											est.</p>

										<p>Ullam dolorum iure dolore dicta fuga ipsa velit
											veritatis molestias totam fugiat soluta accusantium omnis
											quod similique placeat at. Dolorum ducimus libero fuga
								...
								<div class="fh5co-tab-content tab-content" data-tab-content="3" onclick="commentList.do" >
									<div class="col-md-10 col-md-offset-1">
