		   			...
		   			<div class="col-md-6 col-md-offset-3 col-md-pull-3 js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					<div class="desc">
		   						...
		   						<h2>Blueberry Breakfast Salad</h2>
		   						<p>Belly fat-incinerating blueberries, oranges, crunchy granola, and savory salad greens join forces with a light blueberry vinaigrette to create this light and refreshing salad.</p>
		   			...
		   			<div class="col-md-6 col-md-offset-3 col-md-pull-3 js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					<div class="desc">
		   						...
		   						<h2>Spring Pasta Salad</h2>
		   						<p>A one-pot pasta, spring pasta salad with Arugula and almonds and dill tossed in a lemony vinaigrette.</p>
			   					<p><a href="single.html" class="btn btn-primary btn-outline btn-lg">Purchase Now</a></p>
		   					</div>
		   				</div>
		   			</div>
