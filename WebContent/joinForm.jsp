			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6 col-xs-6 text-center menu-1">
						<ul>
							<li class="has-dropdown"><a href="product.html">Shop</a>
								<ul class="dropdown">
						...
						<div class="row form-group">
							<div class="col-md-6">
								<input type="text" name="id" class="form-control" placeholder="id"> <input
									type="password" name="pw" class="form-control" placeholder="password"> <input
									type="text" name="email" class="form-control" placeholder="e-mail"> <input
									type="text" name="addr" class="form-control" placeholder="address" > <input
