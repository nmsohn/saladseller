		...
		<div class="container">
			...
			<div>
				<%if(session.getAttribute("id").equals("owner")){%>
					<input type="button" value="Add product" class="btn btn-primary" onclick="location.href='addForm.do'">
				<%}%>
			</div>
			<div class="row">
				...
				<div class="col-md-4 text-center animate-box">
					<div class="product">
						<div class="product-grid" style="background-image:url(<c:url value="/images/${product.imagePath}" />);">
							<div class="inner">
								<p>
									<a href="single.jsp" class="icon" ng-click = "addToCart('${product.p_id}')"><i class="icon-shopping-cart"></i></a>
									<a href="single.jsp" class="icon"><i class="icon-eye"></i></a>
								</p>
							</div>
						</div>
